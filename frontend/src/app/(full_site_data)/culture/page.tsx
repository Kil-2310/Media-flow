...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: 'Откройте для себя соловьиный край! Народные промыслы, православные святыни, музеи знаменитых земляков и уникальная природа — все это культура Курской области. Для гостей из СНГ и иностранных туристов. | Discover the nightingale land! Folk crafts, Orthodox shrines, museums of famous compatriots and unique nature - all this is the culture of the Kursk region. For guests from CIS and international tourists.',
    ...
    twitter: {
        ...
        description: 'Самобытная культура на стыке традиций. Курский соловей, антоновка, Коренная ярмарка и наследие Свиридова с Дейнекой. Для жителей России, СНГ и гостей из-за рубежа.',
        images: ['/images/region/culture.jpg'],
    },
    category: 'culture',
    classification: 'Культура, Традиции, Народные промыслы, Наследие, Culture, Traditions, Folk Crafts, Heritage',
};
        ...
        <script
            ...
            dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                    ...
                    "description": "Самобытная культура Соловьиного края: кожлянская игрушка, суджанское ковроткачество, Курская Коренская ярмарка, творчество композитора Георгия Свиридова и художника Александра Дейнеки.",
                    "location": {
                        "@type": "Place",
