...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: "Валовой региональный продукт Курской области в 2024 году — 743,3 млрд рублей. В основе экономики — черноземы, железные руды КМА и Курская АЭС. Подробный анализ отраслей: промышленность, энергетика, транспорт. Интерактивная диаграмма и таблица.",
    ...
    twitter: {
        ...
        title: "Экономика и ВРП Курской области: промышленность, энергетика, КМА, АЭС",
        description: "ВРП Курской области 2024: 743,3 млрд рублей. Ключевые отрасли: добыча железной руды, Курская АЭС, машиностроение, химия, транспорт. Анализ структуры и показателей.",
