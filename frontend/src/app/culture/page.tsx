...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            'Откройте для себя соловьиный край! Народные промыслы, православные святыни, музеи знаменитых земляков и уникальная природа — все это культура Курской области.',
    ...
    twitter: {
        ...
        description:
            'Самобытная культура на стыке традиций. Курский соловей, антоновка, Коренная ярмарка и наследие Свиридова с Дейнекой.',
