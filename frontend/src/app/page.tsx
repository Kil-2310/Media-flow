...
export const metadata: Metadata = {
  ...
  description: "Курская область на карте России: подробная информация об экологии, экономике, истории, культуре и туризме региона. Достопримечательности, промышленность и природные особенности Курска.",
  keywords: [
    "Курск", 
    "Курская область", 
    "карта России", 
  ...
  openGraph: {
    title: "Курск и Курская область на карте России: экология, экономика, история, культура, туризм",
    description: "Курская область на карте России: подробная информация об экологии, экономике, истории, культуре и туризме региона.",
    url: "https://kursk-region.ru",
