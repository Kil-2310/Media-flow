...
export const metadata: Metadata = {
  ...
  description: "Полный гид по туризму в Курской области. Усадьба Фета, дворец Барятинских «Марьино», Коренная пустынь, музеи Курской битвы, гладиолусовые луга и гора Фагор. Гостиницы, базы отдыха, экскурсионные маршруты и туроператоры.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "От усадьбы Фета до горы Фагор: дворцы, монастыри, заповедные луга и атомная энергетика. 90 туристических компаний, 134 гостиницы и 11 экскурсионных маршрутов ждут вас.",
  ...
  twitter: {
    ...
    description: "Дворцы и усадьбы, святые места, музеи Курской битвы, клюквенные озера и гладиолусовые луга — все для вашего путешествия.",
...
export default function TourismPage() {
    ...
    return (
        <>
            ...
            <p className="simple_text">По состоянию на 25.06.2020 г. туристская инфраструктура региона включает:</p>
            ...
            <p className="simple_text">Некоторые из объектов из этого списа были рассмотрены ранее: Центрально-Черноземный биосферный заповедник им. В. В. Алёхина, Парк “Патриот”, Горнальский Свято-Николаевский Белогорский мужской монастырь.</p>

            <h2 id="natural_attractions" className="title">Уникальные природные объекты Курской области</h2>

            <p className="simple_text">Один из уникальных природных объектов был рассмотрен ранее: Центрально-Черноземный биосферный заповедник им. В. В. Алёхина</p>
