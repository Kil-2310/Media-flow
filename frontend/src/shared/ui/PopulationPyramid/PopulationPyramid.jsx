...
const populationTrendData = [
    { year: 1897, population: 2370 },
    { year: 1926, population: 2900 },
    { year: 1939, population: 2800 },
    { year: 1959, population: 1480 },
    { year: 1970, population: 1580 },
    { year: 1979, population: 1600 },
    { year: 1989, population: 1620 },
    { year: 2002, population: 1235 },
    { year: 2010, population: 1127 },
    { year: 2021, population: 1082 },
    { year: 2024, population: 1050 },
    { year: 2025, population: 1045 },
];
...
function itemSorter(item) {
    return item.value === 'Male' ? 0 : 1;
}

function PopulationPyramid({ defaultIndex }) {
    return (
        <section className="chart_container">
            <BarChart
                data={percentageData}
                layout="vertical"
                style={{ width: '100%', maxWidth: '700px', height: '70vh', aspectRatio: 1 }}
                responsive
                stackOffset="sign"
                barCategoryGap={1}
            >
...
export default memo(PopulationPyramid);
